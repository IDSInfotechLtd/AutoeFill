...
<form action="<?php echo SITE_HTTP_URL ?>users/addUser" name="addeditUserForm" id="addeditUserForm" method="post" enctype="multipart/form-data" onsubmit="return validate();">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="table_margin">
		<tr>
			<td colspan="4">	
			<?php  if(isset($errMsg) && sizeof($errMsg)!='0') { ?>
			<div class="errormessage tc"><?php  echo $this->Utility->display_message($errMsg,'errmsg',1);?>		
			</div>
			<?php } ?>
			</td>
		</tr>		
		<tr>
			<td align="left" height="30" class="pageimg"><b>Add a new User</b></td>
		</tr>		
		<tr>
		...
		<td colspan="4">		
			<table width="60%" cellpadding="0" cellspacing="0" border="0" class="addeditform">
				<tr class="tablebggrey">
					<td colspan="4" height="25" style="padding-left:10px;" class="formtitle"><b>Add a new User</b></td>
				</tr>	
				<tr>
				...
				<tr>
					...
					<td valign="top" style="padding-top:4px;"><b></b></td>
					<td align="left" valign="top">
					<input id="email" class="manage_Input" type="text" style="width:305px;" name="data[User][email]">	
					</td>
				</tr>
					<tr>
					...
					<td valign="top" style="padding-top:4px;"><b></b></td>
					<td align="left" valign="top">
					<!--input id="phone" class="manage_Input" type="number" style="width:305px;" maxlength="30" name="data[User][phone]"-->
                                    <?php echo $this->Form->input('User.phone',array('id'=>'phone','type'=>'text','class'=>'manage_Input','maxlength'=>30,'label'=>false)); ?>
					</td>
				</tr>
				...
				<tr align="left">
					...
					&nbsp;<span>
					<input type="button" value="Cancel" name="B2" class="button" OnClick="javascript:window.location='<?php echo SITE_HTTP_URL;?>users/viewUsers/'">
					</span>
					</td>
				</tr>
				<tr>
